        ...
        <div class="mt-0">
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="px-2 py-3 bg-white shadow">
                        <div class="row">
                            ...
                            <div class="col-md-10 border-left">
                                ...
                                <p>Facts and opinions in articles published in the Journal of Governance and Development are solely the personal statements of the respective authors.Authors are responsible for all content in their article(s). including factual accuracy, statements, citation of resources, and so on.Journal of Governance <a style="color: brown;" href="">Read more <i class="icon-arrow-right"></i></a></p>
                    ...
                    <div>
                        <div class="pt-4 mt-3 bg-light">
                            <h4 style="border-top:2px solid brown; border-bottom:1px solid black;" class="fw-bold px-0 py-2 text-center">Featured Articles</h4>
                            <div>
                                            ...
                                            <div class="card-body">
                                                <div class="row align-items-center">
                                                    <div class="col-md-9">
                                                        ...
                                                        <p style="text-align: justify;" class="p-0 m-0"><a href="">Abstract</a> An organism’s survival depends on its ability to adapt to stress. Mitochondria are the cellular integrators of environmental stressors that ultimately translate their responses at the organismal level, and are thus central to the process whereby organisms adapt to their respective environments. Mitochondria produce molecular energy via oxidative <span style="color: brown;"><a style="color:inherit;" href=""> more <i class="icon-arrow-right"></i></a></span></p>
                                                    ...
                                                    <div class="col-md-3">
                                                        <img class="w-100" src="https://file.techscience.com/uploads/imgs/202211/6abebd95d75894d3313b6f290a208fd2.png/origin?t=20220620">
                                                    </div>
                                                </div>
                                            </div>
