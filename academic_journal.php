                ...
                <div class="row mt-4">
                        ...
                        <a style="color: inherit;" href="journal-details.php">
                            <div class="journal-card">
                                <div class="p-3 d-flex shadow">
                                    <img style="width: 35%;" src="images/Nazrul.jpg" alt="">
                                    <div style="width:65%" class="ms-3">
                                        <div class="d-flex h-100 flex-column justify-content-between">
                                            ...
                                            <div>
                                                <hr class="mb-1">
                                                <p class="m-0 p-0">Impact Factor: 1.11</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-4">
                        <a style="color: inherit;" href="journal-details.php">
                            <div class="journal-card">
                                <div class="p-3 d-flex shadow">
                                    <img style="width: 35%;" src="images/Governance.png" alt="">
                                    <div style="width:65%" class="ms-3">
                                        <div class="d-flex h-100 flex-column justify-content-between">
                                            <div>
                    ...
                    <div class="col-md-4">
                        <a style="color: inherit;" href="journal-details.php">
                            <div class="journal-card">
                                <div class="p-3 d-flex shadow">
                                    <img style="width: 35%;" src="images/Folklore.jpg" alt="">
                                    <div style="width:65%" class="ms-3">
                                        <div class="d-flex h-100 flex-column justify-content-between">
                                            <div>
                                                <h5 style="font-size: 16px;" class="fw-bold">Journal of Governance and Development</h5>
